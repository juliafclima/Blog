export const dataFake = [
  {
    ...
    descricao:
      'Prepare-se para uma viagem no tempo! X-Men ’97, a animação que vai ressuscitar o icônico desenho dos anos 90 da Marvel, acaba de anunciar sua data de estreia e lançar... -',
    linkNews:
      'https://alternativanerd.com.br/series-tv/x-men-97-ganha-trailer-nostalgico-assista/',
  },
  {
    id: '2',
    photoCover:
    ...
    descricao:
      'Você se considera um NERD? Esse termo que foi passando de geração em geração, se atualizando em seu significado, mesmo tratado por alguns de forma pejorativa, basicamente representa um monte de gente estudiosa que gosta de refletir bastante em assuntos... -',
    linkNews:
      'https://cinepop.com.br/10-filmes-para-voce-que-se-considera-um-grande-nerd-463086/',
  },
  {
    id: '3',
    photoCover:
    ...
    descricao:
      'Novo filme do universo baseado em adaptações do Homem-Aranha é passível de receber o selo “tão ruim que fica bom” Em pleno 2024, os filmes da Sony inspirados por personagens do universo das HQs do Homem-Aranha não surpreendem ao fracassar. Com dois Venoms... -',
    linkNews:
      'https://jovemnerd.com.br/nerdbunker/madame-teia-critica/?_gl=1*dv6rag*_ga*NjkyNTcyNjQxLjE3MDgxMTQ3NjU.*_ga_E05ZNEGCY2*MTcwODExNDc2NC4xLjAuMTcwODExNDc2NC42MC4wLjA',
  },
  {
    id: '4',
    photoCover:
    ...
    descricao:
      'A guerra do streaming movimenta bilhões anualmente, mas algumas armas vitoriosas são apostas bem mais discretas. A Galinha Pintadinha, que está no Top 10 de séries infantis da Netflix há 34 semanas, é uma delas. Seu sucesso é frut... -',
    linkNews:
